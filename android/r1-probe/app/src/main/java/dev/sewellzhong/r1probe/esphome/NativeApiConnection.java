...
public final class NativeApiConnection {
    ...
    // aioesphomeapi 45.6.1 model.py: VOICE_ASSISTANT | SPEAKER | API_AUDIO.
    // These are capability flags, not message IDs. No timers/announce/music are promised.
    public static final int SATELLITE_FEATURES = 7;
            ...
            while (!socket.isClosed()) {
                ...
                if (type==MessageIds.HelloRequest) {
                    ...
                    send(MessageIds.DeviceInfoResponse,EsphomeApi.DeviceInfoResponse.newBuilder().setName(name)
                            ...
                            .setProjectVersion(satellite ? "0.66-hardware-input-dispatch" : "0.43-foundation")
