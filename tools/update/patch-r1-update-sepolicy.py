...
RULES = (
    ...
    ("r1_update_supervisor", "r1_update_supervisor", "process", "fork,signal,sigchld,sigkill"),
    ...
    ("r1_update_supervisor", "sysfs", "dir", "search"),
    ...
    ("r1_update_supervisor", "ion_device", "chr_file", "read,write"),
    ("r1_update_supervisor", "ashmem_device", "chr_file", "read,write"),
    ...
    ("r1_update_supervisor", "apk_data_file", "file", "open,read,getattr"),
    ("r1_update_supervisor", "dalvikcache_data_file", "dir", "open,read,write,search,add_name,getattr"),
    ("r1_update_supervisor", "dalvikcache_data_file", "file", "create,open,read,write,getattr,setattr,lock"),
