...
RULES = (
    ...
    ("r1_update_supervisor", "dalvikcache_data_file", "file", "create,open,read,write,getattr,setattr,lock,unlink"),
    ...
    ("r1_update_supervisor", "r1_update_supervisor", "unix_stream_socket", "create,listen,accept,read,write,getattr,getopt,setopt,shutdown"),
