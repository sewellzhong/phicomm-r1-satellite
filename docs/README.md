...
当前状态与开发顺序见[根 README](../README.md)。历史报告保持原结论；旧下一步不作为执行指令。旧文档中依赖非专业真人控制距离、音量、方向、材料或主观听感的测试/定位/验收，统一由[2026-09-12原厂方案与功能/数据/链路验证边界](2026-09-12-r1-vendor-native-functional-validation.md)取代。
