...
当前状态与开发顺序见[根 README](../README.md)。历史报告保持原结论；旧下一步不作为执行指令。2026-09-14 起真人功能验收和 3～8 台逐台部署按[现行计划](2026-09-14-r1-human-voice-multi-device-plan.md)执行；方向、距离、声学效果和主观听感仍只作诊断。
...
- [原厂方案与功能/数据/链路验证边界](2026-09-12-r1-vendor-native-functional-validation.md)：2026-09-12现行决定；历史真人声学结果保留为诊断，当前和后续只强制可自动复核的功能、数据、链路、安全、恢复与稳定性，依赖真人的效果准确率标记为用户跳过而非通过。
