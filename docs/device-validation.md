...
| v69 页面列表兼容与视觉优化 | 待提交；实机前填写完整 SHA | API 22 / Java 8、Android 149 项、lint、hostcheck APK 和工具 32 项通过；430×900 本地主机渲染检查通过 | 待验证 | 兼容原厂 GET 接口的对象数组和分页接口数组；确认卡片页面、重新扫描、密码显隐、连接按钮及状态文案 | v68 实机页面能打开，但因只解析 `{data:[]}` 而把对象数组误报为空；v69 待覆盖安装后复验 |
